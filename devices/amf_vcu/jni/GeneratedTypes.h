...
enum { CHAN_NUM_AmfRequest_makeReq,CHAN_NUM_AmfRequest_debugDumpReq,CHAN_NUM_AmfRequest_setDmaReadRef,CHAN_NUM_AmfRequest_setDmaWriteRef,CHAN_NUM_AmfRequest_updateMapping,CHAN_NUM_AmfRequest_readMapping,CHAN_NUM_AmfRequest_updateBlkInfo,CHAN_NUM_AmfRequest_readBlkInfo};
...
typedef struct {
    PORTAL_DISCONNECT disconnect;
    int (*makeReq) (  struct PortalInternal *p, const AmfRequestT req, const uint32_t offset );
...
int AmfRequestJson_makeReq ( struct PortalInternal *p, const AmfRequestT req, const uint32_t offset );
int AmfRequestJson_debugDumpReq ( struct PortalInternal *p, const uint32_t card );
...
typedef uint16_t bsvvector_Luint16_t_L8[8];
typedef uint16_t bsvvector_Luint16_t_L8[8];
int AmfIndication_readDone ( struct PortalInternal *p, const uint32_t tag );
int AmfIndication_writeDone ( struct PortalInternal *p, const uint32_t tag );
int AmfIndication_eraseDone ( struct PortalInternal *p, const uint32_t tag, const uint32_t status );
...
enum { CHAN_NUM_AmfIndication_readDone,CHAN_NUM_AmfIndication_writeDone,CHAN_NUM_AmfIndication_eraseDone,CHAN_NUM_AmfIndication_debugDumpResp,CHAN_NUM_AmfIndication_respAftlFailed,CHAN_NUM_AmfIndication_respReadMapping,CHAN_NUM_AmfIndication_respReadBlkInfo};
...
int AmfIndicationJson_readDone ( struct PortalInternal *p, const uint32_t tag );
int AmfIndicationJson_writeDone ( struct PortalInternal *p, const uint32_t tag );
int AmfIndicationJson_eraseDone ( struct PortalInternal *p, const uint32_t tag, const uint32_t status );
